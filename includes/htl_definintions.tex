...
\usepackage{fancyhdr}
\usepackage{lipsum}
\usepackage{footnote} % für Fußnoten in Boxen
...
\definecolor{placeholderred}{RGB}{220,53,69}
...
%	Roter Rahmen für beispielhafte Inhalte (von Schüler:innen zu ersetzen)
\newcommand{\placeholderbox}[2]{%
    \par\vspace{0.5\baselineskip}%
    \begin{savenotes}%
    {\setlength{\fboxsep}{6pt}%
    \noindent\fcolorbox{placeholderred}{white}{%
        \parbox{\dimexpr\linewidth-2\fboxsep-2\fboxrule}{%
            \setlength{\parskip}{0.5\baselineskip}%
            {\tiny\color{placeholderred}\textbf{#1}}\par\nointerlineskip\vspace{0.5\baselineskip} #2%
        }%
    }}%
    \end{savenotes}%
    \par\vspace{0.5\baselineskip}%
