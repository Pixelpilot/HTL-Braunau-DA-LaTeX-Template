...
% Hier wird erläutert, warum das Thema gewählt wurde, welches Problem gelöst
% werden soll und welche Ziele erreicht werden sollen.
...
% Hier wird beschrieben, wie die Arbeit aufgebaut ist und welche Kapitel welche
% Inhalte behandeln.
